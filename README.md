...
세 앱의 개인정보 처리방침과 이용약관. GitHub Pages 로 그대로 서비스한다.

- 오늘을 다르게 — `/differenttoday/privacy/` · `/differenttoday/terms/`
- 심플 다이어리 — `/paperflip/privacy/` · `/paperflip/terms/`
...
- 도담 — `/dodam/` · `/dodam/privacy/` · `/dodam/terms/`
